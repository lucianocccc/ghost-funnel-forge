...
const TASK_CONFIGS = {
  market_research: {
    primaryModel: {
      ...
      model: 'llama-3.1-sonar-huge-128k-online', // Most powerful Perplexity model for deep research
      temperature: 0.2,
      maxTokens: 2000,
    ...
    fallbackModel: {
      modelType: 'perplexity',
      model: 'llama-3.1-sonar-large-128k-online', // Fallback to smaller but still powerful model
      temperature: 0.3,
      maxTokens: 1500,
